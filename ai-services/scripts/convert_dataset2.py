...
# ===== PATHS =====
COCO_JSON = "../datasets/damage/raw/coco-car-damage-detection-dataset/train/COCO_train_annos.json"
IMAGES_DIR = "../datasets/damage/raw/coco-car-damage-detection-dataset/train"
OUTPUT_IMAGES = "../datasets/damage/merged/images/train"
OUTPUT_LABELS = "../datasets/damage/merged/labels/train"
